( () => {
    var e, t, n, i, o = {
            ...
            const i = {
                ...
                tracking: {
                    ...
                    screen: {
                        ...
                        isAdBlockFunctionCall: "pokiTrackingScreenisAdBlockFunctionCall"
                    },
                    playtest: {
        ...
        688: (e, t, n) => {
            ...
            "undefined" == typeof window || s.Z.isPlayground || window.addEventListener("unhandledrejection", (function(e) {
                !function(e) {
            ...
            const b = function() {
                function e(t) {
                    ...
                    this.setDebug = function(e) {
                        ...
                        t.endsWith("poki-gdn.com") || "qa-files.poki.com" === t ? e && o.Z.track(i.Z.tracking.debugTrueInProduction) : (u.Z.debug = e,
                        u.Z.log = null != e ? e : u.Z.log)
                    }
                    ,
                    ...
                    this.gameLoadingFinished = function() {
                        ...
                        o.Z.track(i.Z.tracking.screen.gameLoadingFinished, {
                            ...
                            trackers: (r = window,
                            a = [],
                            "function" != typeof r.ga && "function" != typeof r.gtag || a.push("ga"),
                            r.mixpanel && "function" == typeof r.mixpanel.track && a.push("mixpanel"),
                            "function" == typeof r.GameAnalytics && a.push("gameanalytics"),
                            (r.kongregateAPI || r.kongregate) && a.push("kongregate"),
                            r.FlurryAgent && a.push("flurry"),
                    ...
                    this.gameplayStop = function(e) {
                        n.ignoreEvents() || (n.duringGameplay = !1,
                        o.Z.track(i.Z.tracking.screen.gameplayStop, m(m({}, e), {
                            fps: n.fpsStats.stats()
                        })),
                        clearTimeout(n.playerActiveTimeout),
                    ...
                    this.isAdBlocked = function() {
                        return "GB" !== s.Z.country && n.monetization.isAdBlocked()
                    }
                    ,
                    ...
                    this.shareableURL = function(e) {
                        ...
                        new Promise((function(t, n) {
                            ...
                            if (s.Z.isPokiIframe) {
                                ...
                                t("".concat(c, "?").concat(o.toString())),
                                r.Z.sendMessage(i.Z.message.setPokiURLParams, {
                                    params: e
                                })
                            } else
                                window.self === window.top ? (d.forEach((function(t) {
                    ...
                    ,
                    this.__pokiInternal__playgroundPlatformAd = function(e, t, r, a) {
                        var s = (0,
                        p.Z)();
                        o.Z.track(i.Z.tracking.screen.displayAd, {
                            size: r,
                    ...
                    setInterval((function() {
                        n.badEventsCounter < 10 && (n.badEventsCounter = Math.max(n.badEventsCounter - 1, 0))
                    }
                    ), 6e3)
                }
                return e.prototype.init = function(e) {
                    ...
                    new Promise((function(n, o) {
                        ...
                        r.Z.sendMessage(i.Z.message.sdkDetails, {
                            version: "f19d12fd5e12bb30a40ac068dcbd8ce37ea1427f"
                        })
                    }
                    ))
                }
                    ...
                    return i.forEach((function(e) {
                        if ("true" !== e.getAttribute("data-no-playtest")) {
                            ...
                            a >= n && function(e) {
                                ...
                                return !(n.right < 0 || n.bottom < 0 || n.left > o || n.top > i)
                            }(e) && (a > n && (o = []),
                            o.push({
                                canvas: e,
                                style: t,
        ...
        128: (e, t, n) => {
            ...
            const c = function() {
                ...
                e.trackSavegames = function() {
                    window.cookieStore && window.cookieStore.getAll && i.Z.gameID && (Math.random() > ("GB" === i.Z.country ? .5 : .01) || navigator.userAgent.indexOf("Safari") > -1 && navigator.userAgent.indexOf("Chrome") <= -1 || (e.collectAndLog(),
        ...
        459: (e, t, n) => {
            ...
            var v = function(e, t) {
                ...
                return null !== n && (n.constructor.name === t.name || v(n, t))
            };
            function m(e, t, n) {
            ...
            function z(e, t) {
                return v(t, Element) && (function(e, t) {
                    var n = t.style;
                    if (n) {
                        ...
                        n.transformOrigin = i.transformOrigin) : c(i).forEach((function(o) {
                            ...
                            v(e, HTMLIFrameElement) && "display" === o && "inline" === r && (r = "block"),
                ...
                function(e, t) {
                    v(e, HTMLTextAreaElement) && (t.innerHTML = e.value),
                    v(e, HTMLInputElement) && t.setAttribute("value", e.value)
                }(e, t),
                function(e, t) {
                    ...
                    return P(this, (function(i) {
                        return n || !t.filter || t.filter(e) ? [2, Promise.resolve(e).then((function(e) {
                            return function(e, t) {
                                return T(this, void 0, void 0, (function() {
                                    return P(this, (function(n) {
                                        return v(e, HTMLCanvasElement) ? [2, D(e)] : v(e, HTMLVideoElement) ? [2, B(e, t)] : v(e, HTMLIFrameElement) ? [2, M(e)] : [2, e.cloneNode(!1)]
                                    }
                                    ))
                                }
                                ))
                            ...
                            return function(e, t, n) {
                                return T(this, void 0, void 0, (function() {
                                    ...
                                    return P(this, (function(a) {
                                        ...
                                        case 0:
                                            return r = [],
                                            0 === (r = R(e) && e.assignedNodes ? c(e.assignedNodes()) : v(e, HTMLIFrameElement) && (null === (i = e.contentDocument) || void 0 === i ? void 0 : i.body) ? c(e.contentDocument.body.childNodes) : c((null !== (o = e.shadowRoot) && void 0 !== o ? o : e).childNodes)).length || v(e, HTMLVideoElement) ? [2, t] : [4, r.reduce((function(e, i) {
            ...
            function J(e, t) {
                return H(this, void 0, void 0, (function() {
                    ...
                    return Q(this, (function(r) {
                        switch (r.label) {
                        case 0:
                            return (n = v(e, HTMLImageElement)) && !I(e.src) || v(e, SVGImageElement) && !I(e.href.baseVal) ? [4, _(i = n ? e.src : e.href.baseVal, k(i), t)] : [2];
                        case 1:
                            return o = r.sent(),
            ...
            function Y(e, t) {
                return H(this, void 0, void 0, (function() {
                    return Q(this, (function(n) {
                        switch (n.label) {
                        case 0:
                            return v(e, Element) ? [4, X(e, t)] : [3, 4];
                        case 1:
                            return n.sent(),
                            [4, J(e, t)];
                        case 2:
            ...
            var fe = function(e, t, n, i) {
                ...
                fe(void 0, void 0, void 0, (function() {
                    ...
                    return ve(this, (function(n) {
                        ...
                        case 0:
                            return [4, Ze()];
                        case 1:
                            return (t = n.sent()) && t.length > 10 ? e ? [4, we(t, e)] : [3, 3] : [3, 5];
                        case 2:
                            t = n.sent(),
                            n.label = 3;
                        case 3:
              ...
              , we = function(e, t) {
                return fe(void 0, void 0, void 0, (function() {
                    var n, i, o, r, a, s, d, c, l, u, p, A, h, f, v, m, g, y, b, w, k, Z, E;
            ...
            var A = n(583)
              ...
              , v = function(e) {
                ...
                return Object.keys(e).forEach((function(n) {
                    "object" == typeof e[n] ? t = t.concat(v(e[n])) : t.push(e[n])
                }
                )),
                t
            };
            ...
            var g = n(902)
              ...
              , I = function() {
                ...
                e.setupDefaultEvents = function() {
                    ...
                    t[A.Z.tracking.screen.isAdBlockFunctionCall] = A.Z.tracking.screen.isAdBlockFunctionCall,
                    t);
        ...
        298: (e, t, n) => {
            ...
            const o = function() {
                ...
                e.init = function(t, n) {
                    ...
                    n = !1) : ("qa-files.poki.com" === a || "inspector-uploads.poki-user-content.com" === a || i.Z.isInspector) && (t = !0,
                    n = !0),
                    i.Z.debugMode && (t = !0),
                    i.Z.logMode && (n = !0),
                    void 0 === n && (n = t),
        ...
        888: (e, t, n) => {
            ...
            o.Z)("url_referrer") || "", c = {
                ...
                isInspector: "inspector-uploads.poki-user-content.com" === (null === (s = null === window || void 0 === window ? void 0 : window.location) || void 0 === s ? void 0 : s.host),
                ccpaApplies: (0,
                o.Z)("ccpaApplies"),
                country: ((0,
    ...
    ( () => {
        ...
        function X(e, t) {
            ...
            return (null === (i = null === (n = null == t ? void 0 : t.meta) || void 0 === n ? void 0 : n.advertiserDomains) || void 0 === i ? void 0 : i.length) > 0 && (null === (o = null == t ? void 0 : t.meta) || void 0 === o ? void 0 : o.advertiserDomains.find((function(e) {
                return function(e) {
                    return W.includes(e) || W.includes("www.".concat(e)) || e.includes("game")
                }(e)
            }
        ...
        var J = function() {
          ...
          , oe = function(e, t) {
            if (window.apstag)
                try {
                    var o = function(o) {
                        i.Z.debug && console.log("Boot A9 with APS CCPA Privacy mode:", "".concat(n.Z.ccpaApplies ? "on" : "off"), o);
                        var r = e.settings || J(J({
                        ...
                        window.apstag.init(r, (function() {
                            var i;
                            ee = !function(e) {
                                var t, i, o = n.Z.country, r = null === (i = null === (t = null == e ? void 0 : e[o]) || void 0 === t ? void 0 : t.video) || void 0 === i ? void 0 : i.amazon;
            ...
            var i = ["US", "CA", "AU"]
              ...
              , d = [{
                ...
                bids: K(K([{
                    ...
                    bidder: "sharethrough",
                    params: {
                        pkey: Q.leaderboard[n.Z.siteID] || Q.leaderboard[3]
                    }
                }, {
                    bidder: "triplelift",
                    params: {
                ...
                bids: K(K([{
                    ...
                    bidder: "sharethrough",
                    params: {
                        pkey: Q.skyscraper[n.Z.siteID] || Q.skyscraper[3]
                    }
                }, {
                    bidder: "triplelift",
                    params: {
                ...
                bids: K(K([{
                    ...
                    bidder: "sharethrough",
                    params: {
                        pkey: Q.rectangle[n.Z.siteID] || Q.rectangle[3]
                    }
                }, {
                    bidder: "triplelift",
                    params: {
                ...
                bids: K(K([{
                    ...
                    bidder: "sharethrough",
                    params: {
                        pkey: Q.billboard[n.Z.siteID] || Q.billboard[3]
                    }
                }, {
                    bidder: "triplelift",
                    params: {
                ...
                bids: K(K([{
                    ...
                    bidder: "sharethrough",
                    params: {
                        pkey: Q.mobile_leaderboard[n.Z.siteID] || Q.mobile_leaderboard[3]
                    }
                }, {
                    bidder: "triplelift",
                    params: {
              ...
              , c = J(J({
                ...
                ortb2: {
                    ...
                    device: J({}, window.innerWidth && window.innerHeight ? {
                        w: window.innerWidth,
        ...
        function ae(t, i, o, r, a, s, d) {
            var c, l = s ? "nope" : i, u = M(), p = r ? Y : $, A = 0, h = function() {
                var r, a;
                if (!(--A > 0))
                    try {
                        var h = l
                        ...
                        if (ie()) {
                            ...
                            var v = window.pbjs.adUnits.filter((function(e) {
                                return e.code === p
                            }
                            ))[0];
                            if ("undefined" === v)
                            ...
                            var m = window.pbjs.getHighestCpmBids(p);
                            m.length > 0 && (f = m[0]),
            ...
            ie() && window.pbjs.que.push((function() {
        ...
        function se() {
            ...
            return "yes" === (0,
            D.Z)("poki-ad-server") ? (console.log("DEBUG: Only running Poki-ad-server"),
            !0) : ("localhost" === t || "game-cdn.poki.com" === t || t.endsWith(".poki-gdn.com"),
            !1)
        }
        var de, ce = !1, le = n.Z.testVideos, ue = n.Z.device, pe = function() {
            return le ? "/6062/sanghan_rweb_ad_unit" : "/".concat(S, "/").concat(ue, "_ingame_rewarded_google/").concat(n.Z.siteID, "_").concat(ue, "_ingame_rewarded_google")
        }, Ae = function(n) {
            "desktop" !== ue ? window.googletag.cmd.push((function() {
                t.Z.track(e.Z.tracking.ads.rewardedWeb.request),
                function(e) {
                    googletag.defineOutOfPageSlot && (de && googletag.destroySlots([de]),
                    de = googletag.defineOutOfPageSlot(pe(), googletag.enums.OutOfPageFormat.REWARDED).addService(googletag.pubads()),
                    googletag.enableServices(),
                    Object.keys(e).forEach((function(t) {
                        var n, i = e[t];
                        "" !== i && (null === (n = null == de ? void 0 : de.setTargeting) || void 0 === n || n.call(de, t, i))
                    }
                    )))
                }(n),
                de ? window.googletag.cmd.push((function() {
                    window.googletag.display(de)
                }
            ...
            return t.prototype.moveThroughWaterfall = function() {
                ...
                if (!1 !== this.running) {
                    ...
                    this.rewarded ? Ae(this.criteria) : T.Z.dispatchEvent(e.Z.ads.error, {
                        message: "No ads"
                    })
                }
            }
            ...
            t.prototype.buildAdUnitPaths = function(t) {
                var o = n.Z.device
                  , r = "midroll";
                if ((0,
                D.Z)("noFill") || i.Z.debug)
                    return ["junk", "junk"];
                t === e.Z.ads.position.rewarded && (r = "rewarded");
                var a = "/".concat(S, "/");
                return n.Z.isPokiIframe || n.Z.runningOnPlayground ? ["".concat(a).concat(o, "_ingame_").concat(r, "_1/").concat(this.siteID, "_").concat(o, "_ingame_").concat(r, "_1"), "".concat(a).concat(o, "_ingame_").concat(r, "_2/").concat(this.siteID, "_").concat(o, "_ingame_").concat(r, "_2")] : ["".concat(a, "external_").concat(o, "_video_1/external_").concat(o, "_ingame_").concat(r, "_1"), "".concat(a, "external_").concat(o, "_video_2/external_").concat(o, "_ingame_").concat(r, "_2")]
            }
            ,
            ...
            t.prototype.start = function(t, n) {
                ...
                this.criteria = t,
                this.timing.resetWaterfallTimerIdx(),
                this.rewarded = n === e.Z.ads.position.rewarded,
                this.adUnitPaths = this.buildAdUnitPaths(n),
                this.requestAd()
            }
            ,
            t.prototype.requestAd = function() {
                ...
                r += "&unviewed_position_start=1&url={url}&description_url={descriptionUrl}&correlator={timestamp}";
                ...
                this.ima.requestAd(N())) : this.usePokiAdserver ? (console.debug("adRequest started with Prebid Video enabled (".concat(this.retries, "/").concat(this.totalRetries, ")")),
                ae(this.ima, c, this.criteria, this.rewarded, this.country, !0, this.retries)) : 1 === this.retries ? (console.debug("adRequest started with Prebid Video enabled (".concat(this.retries, "/").concat(this.totalRetries, ")")),
                ae(this.ima, c, this.criteria, this.rewarded, this.country, !1, this.retries)) : (console.debug("adRequest started in plain mode (".concat(this.retries, "/").concat(this.totalRetries, ")")),
        ...
        var ge = "pokiSdkContainer"
          ...
          , be = "pokiSdkOverlay"
          , we = "pokiSdkHidden"
          , ke = "pokiSdkInsideContainer"
          , Ze = "pokiSdkPauseButtonContainer"
          , Ee = "pokiSdkPauseButton"
          , Ie = "pokiSdkPauseButtonBG"
          , Ce = "pokiSdkStartAdButton"
          , xe = "pokiSdkProgressBar"
          , Se = "pokiSdkProgressContainer"
          , _e = "pokiSdkSpinnerContainer"
          , Te = "pokiSdkVideoContainer"
          , Pe = "pokiSdkVisible"
          , De = "pokiSDKAdContainer"
          , Be = "pokiSDKHouseAdContainer"
          , Me = "\n.".concat(ge, " {\n\toverflow: hidden;\n\tposition: absolute;\n\tleft: 0;\n\ttop: 0;\n\twidth: 100%;\n\theight: 100%;\n\tz-index: 1000;\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: center;\n}\n\n.").concat(ge, ".").concat(ye, " {\n\tposition: fixed;\n}\n\n.").concat(ge, ".").concat(Pe, " {\n\tdisplay: block;\n}\n\n.").concat(ge, ".").concat(we, ",\n.").concat(_e, ".").concat(we, " {\n\tdisplay: none;\n}\n\n.").concat(ge, ".").concat(we, ",\n.").concat(_e, " {\n\tpointer-events: none;\n}\n\n.").concat(_e, " {\n\tz-index: 10;\n\tposition: absolute;\n\ttop: 0;\n\tleft: 0;\n\twidth: 100%;\n\theight: 100%;\n\tbackground: url('https://a.poki.com/images/thumb_anim_2x.gif') 50% 50% no-repeat;\n\tuser-select: none;\n}\n\n.").concat(ke, " {\n\tbackground: #000;\n\tposition: relative;\n\tz-index: 1;\n\twidth: 100%;\n\theight: 100%;\n\tdisplay: flex;\n\tflex-direction: column;\n\tjustify-content: center;\n\n\topacity: 0;\n\t-webkit-transition: opacity 0.5s ease-in-out;\n\t-moz-transition: opacity 0.5s ease-in-out;\n\t-ms-transition: opacity 0.5s ease-in-out;\n\t-o-transition: opacity 0.5s ease-in-out;\n\ttransition: opacity 0.5s ease-in-out;\n}\n\n.").concat(ge, ".").concat(Pe, " .").concat(ke, " {\n\topacity: 1;\n}\n\n.").concat(De, ", .").concat(Te, " {\n\tposition: absolute;\n\twidth: 100%;\n\theight: 100%;\n}\n\n.").concat(Ce, " {\n\tposition: absolute;\n\tz-index: 9999;\n\ttop: 0;\n\n\tpadding-top: 10%;\n\twidth: 100%;\n\theight: 100%;\n\ttext-align: center;\n\tcolor: #FFF;\n\n\tfont: 700 15pt 'Arial', sans-serif;\n\tfont-weight: bold;\n\tletter-spacing: 1px;\n\ttransition: 0.1s ease-in-out;\n\tline-height: 1em;\n}\n\n.").concat(Ze, " {\n\tcursor:pointer;\n\twidth: 100%;\n\theight: 100%;\n\tz-index: 10;\n}\n\n.").concat(Ie, " {\n    content: '';\n    background: rgba(0, 43, 80, 0.5);\n    display: block;\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n\tz-index: 11;\n}\n\n.").concat(Ze, ":hover .").concat(Ie, " {\n\tbackground: rgba(0, 43, 80, 0.7);\n}\n\n.").concat(Ee, " {\n\tposition: absolute;\n    top: 50%;\n    left: 50%;\n    z-index: 12;\n}\n\n.").concat(Ee, ":before {\n\tcontent: '';\n\tposition: absolute;\n\twidth: 100px;\n\theight: 100px;\n\tdisplay: block;\n\tborder: 2px solid #fff;\n\tborder-radius: 50%;\n\tuser-select: none;\n\tbackground-color: rgba(0, 0, 0, 0.6);\n\ttransition: background-color 0.5s ease;\n\tanimation: 1s linear infinite pokiPulse;\n\tz-index: 12;\n}\n\n.").concat(Ee, ":after {\n\tcontent: '';\n\tposition: absolute;\n\tdisplay: block;\n\tbox-sizing: border-box;\n\tborder-color: transparent transparent transparent #fff;\n\tborder-style: solid;\n\tborder-width: 26px 0 26px 40px;\n\tpointer-events: none;\n\tanimation: 1s linear infinite pokiPulse;\n\tleft: 6px;\n\tz-index: 12;\n}\n\n@keyframes pokiPulse {\n\t0% {\n\t\ttransform: translate(-50%, -50%) scale(0.95);\n\t}\n\t70% {\n\t\ttransform: translate(-50%, -50%) scale(1.1);\n\t}\n\t100% {\n\t\ttransform: translate(-50%, -50%) scale(0.95);\n\t}\n}\n\n.").concat(Se, " {\n\tbackground: #B8C7DD;\n\twidth: 100%;\n\theight: 5px;\n\tposition: absolute;\n\tbottom: 0;\n\tz-index: 9999;\n}\n\n.").concat(xe, " {\n\tposition:relative;\n\tbottom:0px;\n\tbackground: #FFDC00;\n\theight: 100%;\n\twidth: 0%;\n\ttransition: width 0.5s;\n\ttransition-timing-function: linear;\n}\n\n.").concat(xe, ".").concat(Pe, ", .").concat(Ze, ".").concat(Pe, ", .").concat(Ce, ".").concat(Pe, " {\n\tdisplay: block;\n\tpointer-events: auto;\n}\n\n.").concat(xe, ".").concat(we, ", .").concat(Ze, ".").concat(we, ", .").concat(Ce, ".").concat(we, " {\n\tdisplay: none;\n\tpointer-events: none;\n}\n\n.").concat(De, " .").concat(Be, " {\n\tposition: absolute;\n\twidth: 100%;\n\theight: 100%;\n\tz-index: 99999;\n\tcursor: pointer;\n}\n\n")
          , Re = function() {
            function t(t) {
                var n = this;
            ...
            t.prototype.hide = function() {
                ...
                this.containerDiv.classList.remove(be),
            ...
            t.prototype.show = function() {
                this.containerDiv.classList.add(be),
            ...
            t.prototype.createElements = function(e) {
                ...
                this.insideContainer.className = ke,
                this.pauseButtonContainer.className = Ze,
                this.pauseButton.className = Ee,
                this.pauseButtonBG.className = Ie,
                this.pauseButtonContainer.appendChild(this.pauseButton),
                this.pauseButtonContainer.appendChild(this.pauseButtonBG),
                this.startAdButton.className = Ce,
                this.startAdButton.innerHTML = "Tap anywhere to play ad",
                this.progressBar.className = xe,
                this.progressContainer.className = Se,
                this.spinnerContainer.className = _e,
                this.adContainer.className = De,
                this.videoContainer.className = Te,
                this.hide(),
                ...
                var n = e || null
                  , i = function() {
                    ...
                    n)
                        ...
                        n === document.body)
                            t.containerDiv.classList.add(ye);
                        else {
        ...
        const Ue = function() {
            ...
            var t = encodeURIComponent("".concat(window.location.protocol, "//").concat(window.location.host).concat(e).concat(window.location.search))
              ...
              , i = "/sdk/details.json?href=".concat(t, "&referrer=").concat(n);
            return fetch(i, {
                method: "GET",
                headers: {
        ...
        var Ke = function() {
                ...
                window.googletag.cmd.push((function() {
                    window.googletag.pubads().addEventListener("slotRenderEnded", (function(i) {
                        ...
                        if (l && l.gptSlot) {
                            ...
                            k && n.callOnCanDestroy(l.id),
                            k && l.backfillHouseads ? n.requestHouseAd(l, E) : t.Z.track(e.Z.tracking.ads.display.impression, E)
                        }
                    }
                    )),
            ...
            o.prototype.getDisplaySlotConfig = function(e, t, o) {
                ...
                var d = function(e) {
                    ...
                    w.Z)() ? o = "mobile" : (0,
                    E.Z)() && (o = "tablet"),
                    i.Z.debug || (t = n.Z.isPokiIframe ? "/".concat(S, "/").concat(o, "_ingame_").concat(e, "/").concat(n.Z.siteID, "_").concat(o, "_ingame_").concat(e) : "/".concat(S, "/external_").concat(o, "_display_ingame/external_").concat(o, "_ingame_").concat(e)),
                    t
                }(t);
                o && (d = o);
                var c = "poki-".concat((0,
            ...
            o.prototype.renderAd = function(e) {
                ...
                : A, f = e.onDisplayRendered, v = void 0 === f ? function() {}
                : f, m = e.backfillHouseads, g = void 0 !== m && m, y = e.platformAd, b = void 0 !== y && y, w = this.getDisplaySlotConfig(o, r, l);
            ...
            i.prototype.allBidsBack = function(n) {
                ...
                if (d) {
                    ...
                    if (l) {
                        ...
                        isNaN(h) && (h = 0);
                        var f, v, m = (f = null === (o = null == d ? void 0 : d.amznTargetting) || void 0 === o ? void 0 : o.amznbid,
                        U[f] || 0);
                        m > h ? (v = null === (r = null == d ? void 0 : d.amznTargetting) || void 0 === r ? void 0 : r.amnzp,
                        A = F[v] || "Amazon",
                        h = m,
                        p = !1,
          ...
          , dt = function() {
            function o() {
                ...
                this.sdkNotBootedButCalled = function() {
                    return !(!t.strictConsentMode || t.monetizationCoreLoaded) || (t.strictConsentMode || t.sdkBooted ? t.isAdBlocked() : (console.error("The Poki SDK was not yet booted"),
                    !0))
                }
                ,
                this.genericCriteria = function() {
                    var e = {};
                    if (e.tag = n.Z.tag,
                    e.tag_site = "".concat(n.Z.tag, "|").concat(n.Z.siteID),
                    e.site_id = n.Z.siteID,
                    e.categories = decodeURIComponent(n.Z.categories),
                    n.Z.experiment) {
                        var i = decodeURIComponent(n.Z.experiment);
                        e.experiment = i,
                        n.Z.contentGameID && (e.expid_content_gameid = "".concat(i, "|").concat(n.Z.contentGameID))
                    }
                    return n.Z.specialCondition && t.specialConditions && t.specialConditions.includes(n.Z.specialCondition) ? "landing" === n.Z.specialCondition ? e.p4d_game_id_cond = "".concat(n.Z.gameID, "|l") : "crosspromo" === n.Z.specialCondition ? e.p4d_game_id_cond = "".concat(n.Z.gameID, "|cp") : e.p4d_game_id = n.Z.gameID : e.p4d_game_id = n.Z.gameID,
                    e
                }
                ,
                this.runNonIMAVideoHouseAd = function(n) {
                    T.Z.clearVideoDataAnnotations(),
                    T.Z.setVideoDataAnnotations(n),
                    function() {
                        var e, t, n, i;
                        ...
                        t.playerSkin.show(),
                        t.playerSkin.startNonIMAFallbackVideo(e)
                    }
                    )).catch((function() {
                        y.Z.sendMessage(e.Z.message.sendCommand, {
                            event: "adLibrariesNotLoaded"
                        }),
                        T.Z.dispatchEvent(e.Z.ads.error, it(it({}, n), {
                        ...
                        if ("fulfilled" === l.status) {
                            ...
                            if (A) {
                                ...
                                var h = function(i) {
                                  ...
                                  , m = h.lobbyID
                                  , y = h.record;
                                (m || y) && a.e(545).then(a.bind(a, 545)).then((function(e) {
                                    (0,
                                    e.initPlaytest)(A, m, y)
                                }
                                ))
                            }
            ...
            o.prototype.loadMonetizationCore = function() {
                return ot(this, void 0, void 0, (function() {
                    var o, r, a, s, d, c, l, p, A, h, f, v, m, g, y, w, k = this;
                    return rt(this, (function(Z) {
                        ...
                        case 0:
                            ...
                            A = o.displayOnly,
                            h = void 0 !== A && A,
                            f = it({}, this.initOptions),
                            v = f.nonPersonalized,
                            m = void 0 !== v && v,
                            g = f.familyFriendly,
                            y = void 0 !== g && g,
                            n.Z.isInspector ? (T.Z.dispatchEvent(e.Z.ready),
                            [2]) : (m = m || !!n.Z.nonPersonalized,
                            y = y || !!n.Z.familyFriendly,
                            (0,
                            n.w)("nonPersonalized", m),
                            (0,
                        ...
                        case 2:
                            ...
                            [2, Promise.allSettled(w).then((function(o) {
                                try {
                                    ...
                                    re(a, k.adSettings.bidderLimitation),
                                    oe(d, k.adSettings.bidderLimitation),
                                    window.googletag.cmd.push((function() {
                                        ...
                                        googletag.pubads().addEventListener("rewardedSlotClosed", (function() {
                                            var n, i, o;
                                            ce ? t.Z.track(e.Z.tracking.ads.rewardedWeb.closedGranted) : t.Z.track(e.Z.tracking.ads.rewardedWeb.closedDeclined),
                                        ...
                                        googletag.pubads().addEventListener("slotRenderEnded", (function(n) {
                                            var i;
                                            pe() === (null === (i = null == n ? void 0 : n.slot) || void 0 === i ? void 0 : i.getAdUnitPath()) && n.isEmpty && (t.Z.track(e.Z.tracking.ads.rewardedWeb.empty),
                                            T.Z.dispatchEvent(e.Z.ads.video.startHouseAdFlow))
                                        }
                                        )),
                                    ...
                                    c.customCriteria = it(it({}, c.customCriteria), {
                                        force_ad: u
                                    })),
                                    k.criteria = it({}, c.customCriteria),
                                    k.ima = new Ge(l),
                                    k.playerSkin.setupEvents(k),
                                    k.startStartAdsAfterTimerOnInit && st.startStartAdsAfterTimer(),
                                    k.waterfall = new fe(k.ima,{
                                        timing: st,
                                        totalRetries: p
                                    }),
            ...
            o.prototype.requestAd = function(o) {
                ...
                if (t.Z.track(v === e.Z.ads.position.rewarded ? e.Z.tracking.screen.rewardedBreak : e.Z.tracking.screen.commercialBreak, it(it({}, o.rewardedKVs), y)),
                this.videoRequestInFlight)
                    T.Z.dispatchEvent(e.Z.ads.inFlight, it(it({}, y), {
                        onFinish: p
                    }));
                ...
                null !== v && (0,
                I.Z)(v, e.Z.ads.position))
                    if (this.displayOnly)
                        T.Z.dispatchEvent(e.Z.ads.error, it(it({}, y), {
                            message: "Video disabled"
                        }));
                    else {
                        if (!this.sdkBooted)
                            return T.Z.dispatchEvent(e.Z.ads.error, it(it({}, y), {
                                message: "Requesting ad on unbooted SDK"
                            })),
                            void this.sdkNotBootedButCalled();
                        if (!(0,
                        w.Z)() && !(0,
                        E.Z)() || v === e.Z.ads.position.rewarded)
                            if ((null === (a = null === (r = this.ima) || void 0 === r ? void 0 : r.isAdRunning) || void 0 === a ? void 0 : a.call(r)) || (null === (d = null === (s = this.waterfall) || void 0 === s ? void 0 : s.isRunning) || void 0 === d ? void 0 : d.call(s)))
                                T.Z.dispatchEvent(e.Z.ads.busy, y);
                            else if (v !== e.Z.ads.position.preroll || st.prerollPossible())
                                if (v === e.Z.ads.position.rewarded || st.requestPossible())
                                    if (v !== e.Z.ads.position.rewarded && this.adSettings.countryExclusion.includes(n.Z.country))
                                        T.Z.dispatchEvent(e.Z.ads.limit, it(it({}, y), {
                                            reason: e.Z.info.messages.disabled
                                        }));
                                    else {
                                        if (this.strictConsentMode && !this.monetizationCoreLoaded)
                                            return v === e.Z.ads.position.rewarded || i.Z.debug ? void this.runNonIMAVideoHouseAd(y) : void T.Z.dispatchEvent(e.Z.ads.error, it(it({}, y), {
                                                messaage: "Ad libraries not yet loaded"
                                            }));
                                        if (!this.ima || this.sdkImaError || this.IMARejected)
                                            v === e.Z.ads.position.rewarded ? this.runNonIMAVideoHouseAd(y) : T.Z.dispatchEvent(e.Z.ads.error, it(it({}, y), {
                                            ...
                                            T.Z.dispatchEvent(e.Z.ads.ready, y);
                                        else {
                                            T.Z.clearVideoDataAnnotations(),
                                            T.Z.setVideoDataAnnotations(y);
                                            var b = it(it(it({}, this.genericCriteria()), this.criteria), {
                                                position: v,
                                                ab: Math.round(Math.random()).toString()
                                            });
                                            this.playerSkin.show(),
                                            this.resizeVideoAd(),
                                            this.waterfall.start(b, v)
                                        }
                                    }
                                else
                                    T.Z.dispatchEvent(e.Z.ads.limit, it(it({}, y), {
            ...
            o.prototype.displayAd = function(t) {
                ...
                !1) : m() ? (T.Z.dispatchEvent(e.Z.ads.error, {
            ...
            o.prototype.startStartAdsAfterTimer = function() {
                this.sdkNotBootedButCalled() ? this.startStartAdsAfterTimerOnInit = !0 : st.startStartAdsAfterTimer()
            }
            ,
            ...
            ,
            o.prototype.isAdBlocked = function() {
            ...
            o.prototype.forcePreroll = function() {
                if (!this.sdkNotBootedButCalled()) {
                    var t = st.prerollPossible;
                    st.prerollPossible = function() {
                        return !0
                    }
                    ,
                    this.requestAd({
            ...
            o.prototype.setupDefaultEvents = function() {
                ...
                T.Z.addEventListener(e.Z.adblocked, (function(e) {
                    t.sdkBooted = !0,
                    t.sdkImaError = !0,
                    t.callHandler("onAdblocked", e)
                }
                )),
                ...
                T.Z.addEventListener(e.Z.ads.inFlight, (function(t) {
                    var n, i = it({}, t);
                    delete i.onFinish,
                    null === (n = t.onFinish) || void 0 === n || n.call(t, it(it({}, i), {
                        type: e.Z.ads.busy,
                        rewardAllowed: !1
                    }))
                }
        ...
        const ct = dt;
        var lt = new (a(688).Z)(new ct);
        for (var ut in lt)
            window.PokiSDK[ut] = lt[ut]
    }
    )()
}
)();
